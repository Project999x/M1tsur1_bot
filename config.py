...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7824947804:AAFYkhQasujzGMyjkVo0C7twdgV_IUUiXjY")
...
DB_NAME = os.environ.get("DATABASE_NAME", "@M1tsur1_bot")

#force sub channel id, if you want enable force sub
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002201235972"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002210350227"))
...
#Short Url or Api
SHORT_URL = os.environ.get("SHORTNER_URL", "bharatlinks.com")
SHORT_API = os.environ.get("SHORTNER_API", "8c6c0283f973ec0e56f3165530aa1ffc0674dfd5")
